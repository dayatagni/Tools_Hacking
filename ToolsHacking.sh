...
echo -e  "Tools    : ToolsHacking $white         " |lolcat
echo -e  "Creadby  : Hacking $white   " |lolcat
echo -e  "Contact  : pepenshb0978@gmail.com $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : ToolsHacking" | lolcat
exit
;;
